...
const Productapprovalview = () => {
  ...
  async function getProductDetails() {
    ...
    axios.post(`${BASE_URL}/product_details`, data)
      .then((res) => {
        setOrder(res.data[0])
      })
  }
  ...
  const handleapprove = () => {
    ...
    if (userConfirmed) {
      axios.post(`${BASE_URL}/approve_product`, data)
        .then((res) => {
          if (res.data) {
            ...
            <div className="col-lg-12">
              <div class="card " style={{ height: "250px" }}>
                <div class="card-head">
                  ...
                  <div>
                    <h3 className='card-head-title' style={{ fontSize: "1.1rem" }}>
                      Vendor Name : <span className='text-success'>{order.vendor}</span>
                    </h3>
                  </div>
                </div>
                <div className='row'>
                    ...
                    <div class="card-body">
                      <ul class="list-stats" style={{ paddingLeft: "0", width: "200px" }}>
                        <li class="">
                          ...
                          &nbsp;<span class="value"><b>{order.title} </b></span>
                        </li>
                        <li class="w-200 py-1">
                          <span class="lable">Group:</span>
                          &nbsp; <span class="value"><b>{order.group_name}</b></span>
                        </li>
                        <li class="py-1">
                          <span class="lable">Category:</span>
                          &nbsp; <span class="value"><b>{order.category}</b></span>
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div class="card-body">
                      <ul class="list-stats" style={{ paddingLeft: "0", width: "200px" }}>
                        <li class="">
                          ...
                          &nbsp;<span class="value"><b>{order.subcategory}</b></span>
                        </li>
                        <li class="w-200 py-1">
                          <span class="lable">Brand:</span>
                          &nbsp; <span class="value"><b>{order.brand}</b></span>
                        </li>
                        {/* <li class="py-1">
                    ...
                    <div class="card-body">
                      <ul class="list-stats" style={{ paddingLeft: "0", width: "200px" }}>
                        <li class="">
                          ...
                          &nbsp;<span class="value"><b>{order.price}</b></span>
                        </li>
                        <li class="w-200 py-1">
                          <span class="lable">Discounted Price:</span>
                          &nbsp; <span class="value"><b>{order.disc_price}</b></span>
                        </li>
                        {/* <li class="py-1">
                          <span class="lable">Mobile:</span>
                          &nbsp; <span class="value"><b>93264789</b></span>
            ...
            <div class="col-lg-12 grid-margin stretch-card mt-3">
              <div class="card">
                <div class="card-body">
                        ...
                        {productimg.map((item, index) => {
                          return (
                            <tr className='product-img-table'>
                              ...
                              <td>{item.title}</td>
                              <td><input type='color' value={item.colorcode} /></td>
                  ...
                  <button className='btn btn-danger float-right' type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Not Approve</button>
                  <button className='btn btn-success float-right mx-2' onClick={() => handleapprove()}>Approve</button>
                </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <div class="form-floating">
                          ...
                          <textarea class="form-control" placeholder="Leave a Message here" id="floatingTextarea2" style={{ height: "200px" }}></textarea>
                        </div>
                      </div>
