...
const Address = () => {
    ...
    const handleDefault = (id) =>{
        ...
        axios.post(`${BASE_URL}/update_default`,data)
        .then((res)=>{
            console.log(res)
            getAddressData()
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            axios.post(`${BASE_URL}/add_address`, data)
                .then((res) => {
                    getAddressData()
                    setspinner(false)
                    notify()
    ...
    const handleUpdate = (id) => {
        ...
        axios.post(`${BASE_URL}/address_update`, { u_id: id })
            .then((res) => {
                setUid(res.data[0])
            })
            .catch((err) => {
    ...
    const handleDelete = (id) => {
        ...
        axios.post(`${BASE_URL}/address_delete`, data)
            .then((res) => {
                getAddressData()
    ...
    async function getAddressData() {
        ...
        axios.post(`${BASE_URL}/user_address_data`, data)
            .then((res) => {
                setData(res.data)
            })
            .catch((err) => {
    ...
    return (
        <div className='row p-5'>
            ...
            <div className='col-lg-8 col-md-4 col-12'>
                ...
                <div className='my-2'>
                    <button onClick={handleClickOpen} type='button' className='button button-outline' >Add address +</button>
                </div>
                        ...
                        <form onSubmit={handleSubmit} method='post'>
                            ...
                            <div className='row'>
                                ...
                                <div class="mb-3 col-lg-6">
                                    ...
                                    <input type="email" class="form-control" id="exampleFormControlInput1" value={value.email} placeholder="Enter email" name="email" onChange={onhandlechange} />
                                ...
                                <div class="mb-3 col-lg-4">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Enter city" name="city" onChange={onhandlechange} value={value.city} />
                                    {errors.city && <span className='text-danger'>{errors.city}</span>}
                                </div>
                                <div class="mb-3 col-lg-4">
                                    <label for="exampleFormControlInput1" class="form-label">Pincode</label>
                                    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Enter mobile" name="pincode" onChange={onhandlechange} value={value.pincode} />
                                    {errors.pincode && <span className='text-danger'>{errors.pincode}</span>}
                                </div>

                            </div>

                            <button type='submit' className='button button-outline' >Add +</button>
                        </form>
