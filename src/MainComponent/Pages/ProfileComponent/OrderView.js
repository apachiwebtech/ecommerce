                ...
                <div className='row '>
                    <div className=' col-lg-6'>
                        <div className='card p-3'>
                            ...
                            <hr />
                            <div>
                                <h5>Order No : <span style={{ fontSize: "14px", fontWeight: "300" }}>{order.orderno}</span></h5>
                                <h5>Order Date : <span style={{ fontSize: "14px", fontWeight: "300" }}>{formattedDate}</span></h5>
                                <h5>Order Status : <span style={{ fontSize: "14px", fontWeight: "300" }}>{order.ostatus}</span></h5>
                                <h5>Payment Mode : <span style={{ fontSize: "14px", fontWeight: "300" }}>{order.paymode}</span></h5>
                            </div>
                        </div>
                                ...
                                const ptotal = item.price * item.pqty
                                    return (
                                        <tr>
                                            ...
                                            <td className='text-center'>  <img style={{ width:"100px"}} src={`${IMG_URL}/productimg/` + item.image1} className="" alt="" /> </td>
